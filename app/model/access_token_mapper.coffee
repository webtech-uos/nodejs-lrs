...
# Provides operations for all access tokens on top
# of CouchDB.
#
module.exports = class AccessTokenMapper
  ...
  constructor: (@dbController, callback) ->
    ...
    views = []
    views.push '_design/find_access_token_by' : viewFindBy
    views.push '_design/access_token_list' : viewList
    views.push '_design/access_token_counter' : viewCounter
